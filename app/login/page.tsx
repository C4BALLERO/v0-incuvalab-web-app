  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col">
          ...
          <nav className="flex items-center justify-between max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                <button className="px-4 py-2 bg-white text-[#880430] rounded hover:bg-white/90 transition-colors">
                  Iniciar Sesión
                </button>
                <button
                  onClick={() => router.push("/register")}
                  className="px-4 py-2 bg-[#880430] text-white rounded hover:bg-[#880430]/90 transition-colors"
                >
                  Registrarse
                </button>
              </div>
        ...
        {/* Login form section */}
        <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-[#66B5CB] via-[#66B5CB] to-[#880430]">
